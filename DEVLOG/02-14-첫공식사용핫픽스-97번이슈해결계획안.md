...
|---|------|----------|---------|--------|------|
| 1 | 텍스트 입력 먹통 | `app.js` | **긴급** | 중간 | ⬜ 대기 |
| 2 | 기본 비밀번호 변경 알림 | `app.js`, `auth-manager.js` | 높음 | 낮음 | ⬜ 대기 |
| 3 | 드로잉 레이어 투명도 UI | `timeline.js`, `drawing-manager.js`, `main.css` | 중간 | 중간 | ⬜ 대기 |
| 4 | 타임라인 하이라이트-댓글마커 겹침 | `main.css` | 높음 | 낮음 | ⬜ 대기 |
| 5 | 줌 스크롤 개선 (긴 영상) | `timeline.js` | 중간 | 중간 | ⬜ 대기 |
