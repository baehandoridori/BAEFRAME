...
| 항목 | 수정 파일 | 이유 | 우선순위 | 상태 |
|------|----------|------|---------|------|
| Phase 1 | main/ipc-handlers.js, preload/preload.js | 인증 파일 읽기/쓰기 IPC | 높음 | ⬜ 대기 |
| Phase 2 | renderer/scripts/modules/auth-manager.js (신규) | 인증 로직 모듈 | 높음 | ⬜ 대기 |
| Phase 3 | renderer/scripts/modules/user-settings.js | 로그인 연동 | 높음 | ⬜ 대기 |
| Phase 4 | renderer/index.html, renderer/styles/ | 로그인 UI | 높음 | ⬜ 대기 |
| Phase 5 | renderer/scripts/modules/comment-manager.js | 코멘트/답글 권한 체크 | 높음 | ⬜ 대기 |
